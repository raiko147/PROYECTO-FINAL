...
#cursor.execute("CREATE TABLE cursos(codigo integer primary key,descripcion var(20) not null,"
               "tipo_curso int(3) not null, observaciones var(60));")
con.commit()
...
#cursor.execute("CREATE TABLA pagos(codigo_recibo integer primary key concepto var(60) not null,"
                "cantidad int(1) not null, nombre var(20) );")

con.commit()
#creacion de tabla docentes
#cursor.execute("CREATE TABLE docentes(id integer primary key, nombre var(20) not null,"
                "apellidos var(20) not null, edad int(2) not null, dni int(8) not null, direccion var(30) not null,"
                "sexo var(1) not null, correo var(32) not null, especialidad var(60) not null, observaciones var(60));")
...
#cursor.execute("CREATE TABLE docentes(id integer primary key, nombre var(20) not null,"
                "apellidos var(20) not null, edad int(2) not null, dni int(8) not null, observaciones var(60));")
con.commit()                
#cerrar coneccion
